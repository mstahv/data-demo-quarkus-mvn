...
insert into Book_Author (authors_ssn, books_isbn) values ('126-24-9867', '9781932394153');
insert into Book_Author (authors_ssn, books_isbn) values ('126-24-9867', '9781932394887');
insert into Book_Author (authors_ssn, books_isbn) values ('XXX-YYY', '9781932394153');
insert into Book_Author (authors_ssn, books_isbn) values ('XXX-YYY', '9781932394887');
